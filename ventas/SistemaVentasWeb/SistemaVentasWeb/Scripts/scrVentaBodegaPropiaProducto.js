function TablaHtml() {
    ...
    this.rendering = function () {
        ...
        if (this.arrFilas.length > 0) {
            ...
            $html += '<td class="tdLeftCortado" colspan="14">Datos de la Venta</td>';
            $html += '</tr>';
            ...
            for (i = 0; i < this.arrFilas.length; i++) {
                ...
                switch (lineaProducto.auxCargoAutorizador.toLowerCase()) {
                    case "jefe oficina":
                        strStyle = 'style="background-color:#82d882;"'
                        break;
                    ...
                    case "gerente distribución":
                        strStyle = 'style="background-color:orange;"'
                        break;
            ...
            $html += '<tr><td class="tdLeft">           </td><td class="tdLeft" colspan="9">                                 </td><td class="tdLeft">Total Neto </td><td class="tdRight">' + intTotalNeto + ' </td><td></td><td></td></tr>';
            $html += '<tr><td class="tdLeft">Cant.Items:</td><td class="tdLeft" colspan="9">' + intCantidadProductos + '     </td><td class="tdLeft">Total IVA  </td><td class="tdRight">' + intTotalIva + '  </td><td></td><td></td></tr>';
            $html += '<tr><td class="tdLeft">Marg.Final:</td><td class="tdLeft" colspan="9">' + dblTotalMargenComercial + ' %</td><td class="tdLeft">Total Bruto</td><td class="tdRight">' + intTotalBruto + '</td><td></td><td></td></tr>';
            $html += '</table>';
            return $html;
        }
        return '';
