...
$(document).ready(function () {
    ...
    CargarTextoProducto();
    CargarComboRegion();
    CargarComboPlazoCompra();
    CargarTextoProveedorCompra();
    CargarComboMotivo();
    $("#divLoader1").css({
        display: "none"
    });
            ...
            $(xml).find("ArrayOfClsProducto").each(function () {
                $(this).find("clsProducto").each(function () {
                    ...
                    if ((strMonedaPago == 'USD' || strMonedaPago == 'EUR') && (strMonedaPago != strMonedaProducto)) {
                        ...
                        document.getElementById("txtMonedaProductoCompra").value = $registro.find("ArtMoneda").text();
                        document.getElementById("txtPrecioUnitarioProductoCompra").value = $registro.find("ArtCostoComercial").text();
        ...
        success: function (xml) {
            $(xml).find("ArrayOfClsBodega").each(function () {
                $(this).find("clsBodega").each(function () {
                    ...
                    if (BodTipoVenta == "VentaCalzadaProveedor") {
                        if (BodDefecto == "Y") {
    ...
    $("#txtBuscaProducto").autocomplete({
        ...
        select: function (event, ui) {
            ...
            if ((strMonedaPago == 'USD' || strMonedaPago == 'EUR') && (strMonedaPago != strMonedaProducto)) {
                ...
                document.getElementById("txtMonedaProductoCompra").value = ui.item.ArtMoneda;
                document.getElementById("txtPrecioUnitarioProductoCompra").value = ui.item.ArtCostoComercial.toFixed(6);
...
function ValidarLineaProducto() {
  ...
  //}
    ...
    if (document.getElementById("txtFechaCompra").value == "") {
        alert("Debe seleccionar plazo de compra.");
        document.getElementById("cmbPlazoCompra").focus();
        return false;
    }
    if (parseInt(document.getElementById("cmbMotivo").options[document.getElementById("cmbMotivo").selectedIndex].value) == 0) {
        alert("Debe seleccionar motivo asociado a la compra.");
        document.getElementById("cmbMotivo").focus();
        return false;
    }
    if (document.getElementById("txtTasaInteresCompra").value == "") {
        alert("Debe digitar tasa de interes a aplicar.");
        document.getElementById("txtTasaInteresCompra").focus();
        return false;
    }
    else if (parseFloat(document.getElementById("txtTasaInteresCompra").value) < 1.8) {
        alert("Tasa de interes a aplicar no debe ser inferior a 1.8.");
        document.getElementById('txtTasaInteresCompra').value = "1.8";
        document.getElementById("txtTasaInteresCompra").focus();
        return false;
    }
    if (document.getElementById("txtPrecioUnitarioProductoCompra").value == "") {
        alert("Debe digitar precio unitario de compra del producto.");
        document.getElementById("txtPrecioUnitarioProductoCompra").focus();
        return false;
    }
    if (document.getElementById("txtCodigoProveedorCompra").value == "") {
        alert("Debe buscar datos del proveedor para continuar.");
        document.getElementById("txtBuscaProveedorCompra").focus();
        return false;
    }
    if (document.getElementById("txtCondicion").value == "") {
        alert("Debe digitar nombre y apellido de quien entrego la condicion de compra del producto.");
        document.getElementById("txtCondicion").focus();
        return false;
    }
  //if (!ValidarPlazosNegocio()) {
  //    alert("Plazo de compra no puede ser superior a plazo de venta.");
  //    document.getElementById("cmbPlazoCompra").focus();
  //    return false;
  //}
    ...
    var fltTasaInteresCompra = 0.00;
    var dblPrecioUnitarioProductoCompra = 0.000000;
    var intTotalUnitarioProductoCompra = 0;
  ...
  //document.getElementById("txtMargenComercialProducto").value = dblMargenComercialProducto;
    ...
    dblPrecioUnitarioProductoCompra = (parseFloat(document.getElementById("txtPrecioUnitarioProductoCompra").value)).toFixed(6);
    document.getElementById("txtPrecioUnitarioProductoCompra").value = dblPrecioUnitarioProductoCompra;


    intTotalUnitarioProductoCompra = ((intCantidadProducto * dblPrecioUnitarioProductoCompra) * dblTipoCambio).toFixed(0);
    document.getElementById("txtTotalUnitarioProductoCompra").value = intTotalUnitarioProductoCompra;


    dblMargenComercialProducto = (100 - ((dblPrecioUnitarioProductoCompra * 100) / dblPrecioUnitarioProducto)).toFixed(2);
    document.getElementById("txtMargenComercialProducto").value = dblMargenComercialProducto;
    ...
    fltTasaInteresCompra = (parseFloat(document.getElementById("txtTasaInteresCompra").value)).toFixed(2);
    document.getElementById("txtTasaInteresCompra").value = fltTasaInteresCompra;


    document.getElementById("txtMotivo").value = document.getElementById("cmbMotivo").options[document.getElementById("cmbMotivo").selectedIndex].text;
    document.getElementById("hdnMotivo").value = parseInt(document.getElementById("cmbMotivo").options[document.getElementById("cmbMotivo").selectedIndex].value);
...
function CargarTextoInteresProducto() {
    ...
    var fltTasaInteres = parseFloat(document.getElementById("txtTasaInteresCompra").value);
    var strFechaVencimiento = document.getElementById("txtFechaVencimiento").value;
    var strFechaCompra = document.getElementById("txtFechaCompra").value;
    $.ajax({
        type: "post",
        async: false,
...
function CargarTextoDescuentoProducto() {
    var intOpcion = 20;
    //var strCliente = document.getElementById("txtCodigoCliente").value;
    //var strBodega = document.getElementById("cmbBodega").options[document.getElementById("cmbBodega").selectedIndex].value;
    var strProducto = document.getElementById("txtCodigoProducto").value;
        ...
        success: function (xml) {
            $(xml).find("ArrayOfClsDescuentoProducto").each(function () {
                $(this).find("clsDescuentoProducto").each(function () {
                    var $registro = $(this);
                    document.getElementById("hdnDescuentoProducto").value = $registro.find("ArtDescuento").text();
                });
            });
        }
    });
...
function LimpiarLineaProducto() {
  ...
  //document.getElementById("cmbPlazoCompra").value = "0_0";
  //document.getElementById("hdnPlazoCompra").value = "";
  //document.getElementById("hdnDiasCompra").value = "";
  //document.getElementById("txtFechaCompra").value = "";
    document.getElementById("txtTasaInteresCompra").value = "1.80";
    document.getElementById("txtMonedaProductoCompra").value = "";
    document.getElementById("txtPrecioUnitarioProductoCompra").value = "";
    document.getElementById("txtTotalUnitarioProductoCompra").value = "";
  //document.getElementById("txtBuscaProveedorCompra").value = "";
  //document.getElementById("txtNombreProveedorCompra").value = "";
  //document.getElementById("txtCodigoProveedorCompra").value = "";
    LimpiarTextoProveedor();
...
function VerificarAutorizacionPorTasa() {
    tablaHtml.porTasa = true;
    $("#hdnAutorizacionTasa").val("true");
    return true;
}
...
function RegistrarBorradorVenta() {
    var intUsuario = parseInt(parent.document.getElementById("hdnUsuario").value);
    var strTipoVenta = "ventaCalzadaProveedor";
    var strCliente = document.getElementById("txtCodigoCliente").value;
    var strMonedaPago = document.getElementById("cmbMonedaPago").options[document.getElementById("cmbMonedaPago").selectedIndex].value;
    ...
    var strFechaVencimiento = document.getElementById("txtFechaVencimiento").value;
    var strPlazoCompra = document.getElementById("cmbPlazoCompra").options[document.getElementById("cmbPlazoCompra").selectedIndex].value;
    var arrPlazoCompra = strPlazoCompra.split("_");
    var intCodigoPlazoCompra = arrPlazoCompra[0];
    ...
    var strComentario3 = document.getElementById("txtComentario3").value;
    var intMotivo = 0;//parseInt(document.getElementById("cmbMotivo").options[document.getElementById("cmbMotivo").selectedIndex].value);
    var strEmision = document.getElementById("cmbEmision").options[document.getElementById("cmbEmision").selectedIndex].value;
...
function EnviarAutorizacionCorreo(intDocEntry) {
    ...
    var strComentario2 = document.getElementById("txtComentario2").value;
    var strComentario3 = document.getElementById("txtComentario3").value;
    var strMotivo = 0;//document.getElementById("cmbMotivo").options[document.getElementById("cmbMotivo").selectedIndex].text;
    var strEmision = document.getElementById("cmbEmision").options[document.getElementById("cmbEmision").selectedIndex].value;
    var strGuiaDespacho = document.getElementById("txtGuiaDespacho").value;
    var strCategoria = document.getElementById("txtCategoria").value;
    var strVendedor = document.getElementById("cmbVendedor").options[document.getElementById("cmbVendedor").selectedIndex].text;
...
function CargarComboPlazoCompra() {
    var intOpcion = 10;
    var intPlaCodigo = "0_0";
    var intIndex = 0;
    var cmbPlazoCompra = document.getElementById("cmbPlazoCompra");
    cmbPlazoCompra.options.length = 0;
    $.ajax({
        type: "post",
        async: false,
        url: "/Services/srvPlazoCompra.asmx/ObtenerPlazoCompra",
        dataType: "xml",
        data: { "intOpcion": intOpcion },
        success: function (xml) {
            $(xml).find("ArrayOfClsPlazoCompra").each(function () {
                $(this).find("clsPlazoCompra").each(function () {
                    var $registro = $(this);
                    var PlaCodigo = $registro.find("PlaCodigo").text();
                    var PlaItem = $registro.find("PlaItem").text();
                    var PlaNombre = $registro.find("PlaNombre").text();
                    if (PlaCodigo == intPlaCodigo) {
                        cmbPlazoCompra.options[intIndex] = new Option(PlaNombre, PlaItem, true, true);
                    }
                    else {
                        cmbPlazoCompra.options[intIndex] = new Option(PlaNombre, PlaItem);
                    }
                    intIndex++;
                });
            });
...
function ActualizarFechaCompra() {
    if (document.getElementById("cmbPlazoCompra").value != "0_0") {
        var strPlazoCompra = document.getElementById("cmbPlazoCompra").options[document.getElementById("cmbPlazoCompra").selectedIndex].value;
        var strFechaOrdenVenta = document.getElementById("txtFechaOrdenVenta").value;
        var arrDiasPlazoCompra = strPlazoCompra.split("_");
        var intDiasPlazoCompra = arrDiasPlazoCompra[1];
        document.getElementById("hdnPlazoCompra").value = arrDiasPlazoCompra[0];
        document.getElementById("hdnDiasCompra").value = arrDiasPlazoCompra[1];
        var arrFechaOrdenVenta = strFechaOrdenVenta.split("/");
        var datFechaOrdenVenta = new Date(arrFechaOrdenVenta[2], arrFechaOrdenVenta[1] - 1, arrFechaOrdenVenta[0]);
        var datFechaCompra = new Date(datFechaOrdenVenta.getTime() + (intDiasPlazoCompra * 24 * 3600 * 1000));
        var intDiaCompra = datFechaCompra.getDate();
        var intMesCompra = datFechaCompra.getMonth() + 1;
        var intAñoCompra = datFechaCompra.getFullYear();
        if (intDiaCompra < 10) {
            intDiaCompra = "0" + intDiaCompra;
        }
        if (intMesCompra < 10) {
            intMesCompra = "0" + intMesCompra;
        }
        document.getElementById("txtFechaCompra").value = intDiaCompra + "/" + intMesCompra + "/" + intAñoCompra;
        //RestaurarInteresProducto();
        //RestaurarDescuentoProducto();
    }
    else {
...
function CargarTextoProveedorCompra() {
    $("#txtBuscaProveedorCompra").autocomplete({
        max: 10,
        source: function (request, response) {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "/Services/srvProveedor.asmx/ObtenerProveedor",
                dataType: "json",
                data: "{ 'strProveedor':'" + request.term + "'}",
                success: function (data) {
                    response($.map(data.d, function (item) {
                        return {
                            label: item.ProCodigo + " " + item.ProNombre,
                            value: '',
                            ProNombre: item.ProNombre,
        ...
        minLength: 2,
        select: function (event, ui) {
            document.getElementById("txtNombreProveedorCompra").value = ui.item.ProNombre;
            document.getElementById("txtCodigoProveedorCompra").value = ui.item.ProCodigo;
            //RestaurarProveedorCompra();
        },
        //open: function () {
...
function ValidarPlazosNegocio() {
    ...
    var arrDiasPlazoCompra = strPlazoCompra.split("_");
    var intDiasPlazoCompra = arrDiasPlazoCompra[1];
    //alert(intDiasPlazoVenta + " vs " + intDiasPlazoCompra);
    if (parseInt(intDiasPlazoVenta) >= parseInt(intDiasPlazoCompra)) {
        return true;
    }
    else {
        return false;
...
function LimpiarTextoProveedor() {
    document.getElementById("txtBuscaProveedorCompra").value = "";
    document.getElementById("txtNombreProveedorCompra").value = "";
    document.getElementById("txtCodigoProveedorCompra").value = "";
    document.getElementById("txtCondicion").value = "";
    document.getElementById("cmbMotivo").selectedIndex = 0;
    document.getElementById("txtMotivo").value = "";
    document.getElementById("hdnMotivo").value = "";
}
/***************************************************************************/
function ActualizarIncluyeFlete() {
    CambiarIncluyeFlete(0);
}
function LimpiarTextoCondicion() {
    document.getElementById("txtCondicion").value = "";
}
function CargarComboMotivo() {
    var strParametro = "motivo";
    var intIndex = 0;
    var cmbMotivo = document.getElementById("cmbMotivo");
    cmbMotivo.options.length = 0;
    $.ajax({
        type: "post",
        async: false,
        url: "/Services/srvParametro.asmx/ObtenerParametro",
        ...
        success: function (xml) {
            $(xml).find("ArrayOfClsParametro").each(function () {
                $(this).find("clsParametro").each(function () {
                    var $registro = $(this);
                    var ParCodigo = $registro.find("ParCodigo").text();
                    var ParNombre = $registro.find("ParNombre").text();
                    cmbMotivo.options[intIndex] = new Option(ParNombre, ParCodigo);
                    intIndex++;
                });
            });
        }
...
function ActualizarMotivo() {
    var intMotivo = parseInt(document.getElementById("cmbMotivo").options[document.getElementById("cmbMotivo").selectedIndex].value);
    if (intMotivo == 0) {
        alert("Debe seleccionar motivo asociado a la compra del producto.")
    }
}