...
function Consultar() {
    ...
    var intAño = parseInt(datFecha.getFullYear());
    var intMes = parseInt(datFecha.getMonth()) + 1;
    var intDia = parseInt(datFecha.getDate());
    //if (intDia <= 7) {
    //    intMes--;
    //    if (intMes == 0) {
    //        intAño--;
    ...
    //    }
    //}
    var strMesCurso = ObtenerNombreMesLargo(intMes) + " DE " + intAño;
    $("#divMesCurso").html(strMesCurso);
    if (ValidarUsuarioEspecial()=="True") {
        CargarCuadroDetalleLineaEspecial(0);
    }
    else {
        CargarCuadroDetalleLinea(0);
    }
}
function ValidarUsuarioEspecial() {
    ...
    var strSubLinea = "";
    var strDocto = "";
    var blnUsuarioEspecial = "False";
    try {
        $.ajax({
            type: "POST",
            async: false,
            url: "/Services/srvLiquidacionComision.asmx/ValidarUsuarioComisionProvisorio",
            dataType: "xml",
            ...
            success: function (xml) {
                blnUsuarioEspecial = $(xml).find("string").text();
            }
        });
    }
    catch (err) {
...
function CargarCuadroDetalleLinea(intIdentificador) {
    ...
    $.ajax({
        type: "post",
        async: false,
        url: "/Services/srvLiquidacionComision.asmx/ObtenerComisionDetalleProvisorioLinea",
        dataType: "xml",
        data: { "intEmpleado": intEmpleado, "intOperador": intOperador, "intAño": intAño, "intMes": intMes, "intIdentificador": intIdentificador, "strOficina": strOficina, "intLinea": intLinea, "strSubLinea": strSubLinea, "strDocto": strDocto },
        success: function (xml) {
...
function CargarCuadroDetalleDocumento(intIdentificador, intLinea, strSubLinea, strDocto) {
    ...
    $.ajax({
        type: "post",
        async: false,
        url: "/Services/srvLiquidacionComision.asmx/ObtenerComisionDetalleProvisorioDocumento",
        dataType: "xml",
        data: { "intEmpleado": intEmpleado, "intOperador": intOperador, "intAño": intAño, "intMes": intMes, "intIdentificador": intIdentificador, "strOficina": strOficina, "intLinea": intLinea, "strSubLinea": strSubLinea, "strDocto": strDocto },
        success: function (xml) {
            $(xml).find("ArrayOfClsLiquidacionComisionDetalle").each(function () {
...
function CargarCuadroDetalleLineaEspecial(intIdentificador) {
    ...
    $.ajax({
        type: "post",
        async: false,
        url: "/Services/srvLiquidacionComision.asmx/ObtenerComisionDetalleProvisorioLineaEspecial",
        dataType: "xml",
        data: { "intEmpleado": intEmpleado, "intOperador": intOperador, "intAño": intAño, "intMes": intMes, "intIdentificador": intIdentificador, "strOficina": strOficina, "intLinea": intLinea, "strSubLinea": strSubLinea, "strDocto": strDocto },
        success: function (xml) {
            $(xml).find("ArrayOfClsLiquidacionComisionDetalle").each(function () {
...
function CargarCuadroDetalleDocumentoEspecial(intIdentificador, strOficina, intLinea) {
    ...
    $.ajax({
        type: "post",
        async: false,
        url: "/Services/srvLiquidacionComision.asmx/ObtenerComisionDetalleProvisorioDocumentoEspecial",
        dataType: "xml",
        data: { "intEmpleado": intEmpleado, "intOperador": intOperador, "intAño": intAño, "intMes": intMes, "intIdentificador": intIdentificador, "strOficina": strOficina, "intLinea": intLinea, "strSubLinea": strSubLinea, "strDocto": strDocto },
        success: function (xml) {
            $(xml).find("ArrayOfClsLiquidacionComisionDetalle").each(function () {
