...
Public Class pagAprobarBorrador
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If (Me.strConcepto = "CREDITOS" Or Me.strConcepto = "DEUDA VENCIDA" Or Me.strConcepto = "PROTESTOS") Then
            chkBloquear.Visible = True
        End If
        Dim strLogo As String = IIf(IsNothing(Request.QueryString("x")), "", Request.QueryString("x"))
        If (strLogo.Trim = "x") Then
            imgLogo.Visible = False
        End If
        lblTituloSeccion.Text = "Aprobacion de Pedido N° " + Me.intDocEntry.ToString
    ...
    Protected Sub btnAceptar_Click(sender As Object, e As EventArgs) Handles btnAceptar.Click
        ...
        Dim intBloqueaGD As Integer = IIf(chkBloquear.Checked, 1, 0)
        lblMensaje.Text = intBloqueaGD.ToString
        If (ActualizarDispatcher()) Then
            If (ActualizarAutorizaciones()) Then
                ...
                If (blnRespuesta) Then
                    lblMensaje.Text = "Proceso de aprobacion ha finalizado con exito."
                Else
                    lblMensaje.Text = "Ha ocurrido un error al intentar aprobar el pedido."
                End If
            Else
