...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        ...
        <title>Ventas Web - Venta Calzada Propia</title>
        ...
        <script type="text/javascript" src="../Scripts/scrVentaCalzadaPropiaProducto.js"></script>
        <script type="text/javascript" src="../Scripts/scrVentaCalzadaPropiaProductoCarga.js"></script>
        <script type="text/javascript" src="../Scripts/scrVentaCalzadaPropia.js"></script>
    </head>
    <body style="zoom:75%">
