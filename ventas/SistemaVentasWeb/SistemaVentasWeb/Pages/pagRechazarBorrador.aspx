<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pagRechazarBorrador.aspx.vb" Inherits="SistemaVentasWeb.pagRechazarBorrador" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="zoom:75%">
        <form id="frmRechazarBorrador" runat="server">
            <table border="0">
                ...
                <tr><td class="tdCenter"><asp:Button ID="btnAceptar" runat="server" Text="Rechazar"/></td></tr>
