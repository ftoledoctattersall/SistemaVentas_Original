<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pagVentaConsignada.aspx.vb" Inherits="SistemaVentasWeb.pagVentaConsignada" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        ...
        <title>Ventas Web - Venta Consignada</title>
        ...
        <script type="text/javascript" src="../Scripts/scrVentaConsignadaProducto.js"></script>
        <script type="text/javascript" src="../Scripts/scrVentaConsignadaProductoCarga.js"></script>
        <script type="text/javascript" src="../Scripts/scrVentaConsignada.js"></script>
    </head>
    <body style="zoom:75%">
        <form id="frmVentaConsignada" runat="server">
