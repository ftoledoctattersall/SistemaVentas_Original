<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pagVentaLiquidacion.aspx.vb" Inherits="SistemaVentasWeb.pagVentaLiquidacion" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        ...
        <title>Ventas Web - Venta Liquidacion</title>
        ...
        <script type="text/javascript" src="../Scripts/scrVentaLiquidacionProducto.js"></script>
        <script type="text/javascript" src="../Scripts/scrVentaLiquidacionProductoCarga.js"></script>
        <script type="text/javascript" src="../Scripts/scrVentaLiquidacion.js"></script>
    </head>
    <body style="zoom:75%">
        <form id="frmVentaLiquidacion" runat="server">
