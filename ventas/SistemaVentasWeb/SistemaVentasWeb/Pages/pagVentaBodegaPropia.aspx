<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pagVentaBodegaPropia.aspx.vb" Inherits="SistemaVentasWeb.pagVentaBodegaPropia" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        ...
        <title>Ventas Web - Venta Bodega Propia</title>
        ...
        <script type="text/javascript" src="../Scripts/scrVentaBodegaPropiaProducto.js"></script>
        <script type="text/javascript" src="../Scripts/scrVentaBodegaPropiaProductoCarga.js"></script>
        <script type="text/javascript" src="../Scripts/scrVentaBodegaPropia.js"></script>
    </head>
    <body style="zoom:75%">
        <form id="frmVentaBodegaPropia" runat="server">
            ...
            <div class="container-fluid">
                ...
                <div id="row2" class="row" style="display:none">
                    <div class="col-sm-6">
                        <table border="0">
                            <tr class="trTituloSeccion"><td colspan="7">Condiciones de Venta</td></tr>
                            <tr>
                                ...
                                <td class="tdLeft">Fecha.Vecto.</td>
                            ...
                            <tr>
                                ...
                                <td class="tdLeft">Precio Unitario C/Flete</td>
                            ...
                            <tr>
                                ...
                                <td class="tdLeft">Precio Unitario</td>
...
--%>
                            ...
                            <tr>
                                <td colspan="2" class="tdCenter">
                                    ...
                                    <%--<input id="btnCrearVoucher" type="button" runat="server" value="Crear Voucher" onclick="CrearVoucher();"/>--%>
                                    <div id="divLoader2"><img src="../Images/loader.gif"/></div>
                                    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                                    <%--<asp:ImageButton ID="btnImprimir" CausesValidation="false" runat="server" ImageUrl="~/Images/agrega.png" onclick="btnImprimir_Click" OnClientClick="if (verificaSePuedeImprimir()==false) return false;" width="24" height="24" AlternateText="Crear PDF" title="Crear PDF"/>--%>
                                    <div id="divVoucher">
