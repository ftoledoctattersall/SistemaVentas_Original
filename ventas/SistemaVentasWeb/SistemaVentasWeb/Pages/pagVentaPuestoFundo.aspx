<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pagVentaPuestoFundo.aspx.vb" Inherits="SistemaVentasWeb.pagVentaPuestoFundo" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        ...
        <title>Ventas Web - Venta Puesto Fundo</title>
        ...
        <script type="text/javascript" src="../Scripts/scrVentaPuestoFundoProducto.js"></script>
        <script type="text/javascript" src="../Scripts/scrVentaPuestoFundoProductoCarga.js"></script>
        <script type="text/javascript" src="../Scripts/scrVentaPuestoFundo.js"></script>
    </head>
    <body style="zoom:75%">
        <form id="frmVentaPuestoFundo" runat="server">
                    ...
                    <div class="col-sm-8">
                        <table border="0">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td><select id="cmbTipoDespacho" name="cmbTipoDespacho" class="textboxLong"></select></td>
                            </tr>
                            <tr>
                    ...
                    <div class="col-sm-6">
                        <table border="0">
                            ...
                            <tr>
                                ...
                                <td class="tdLeft"><input id="txtMonedaProducto"          type="text" class="textboxSmallerReadonly" readonly="true"/><input id="txtPrecioUnitarioProducto"  type="text" class="textboxSmall"           maxlength="8" onkeypress="return ValidarNumeroDecimal(event);"/></td>
                            ...
                            <tr>
                                ...
                                <td class="tdLeft"><input id="txtFleteProducto"           type="text" class="textboxSmallReadonly"   readonly="true"/></td>
                            ...
                            <tr>
                                ...
                                <td class="tdLeft"><input id="txtMonedaProductoCompra"         type="text" class="textboxSmallerReadonly" readonly="true"/><input id="txtPrecioUnitarioProductoCompra" type="text" class="textboxSmall"           maxlength="8" onkeypress="return ValidarNumeroDecimal(event);"/></td>
                                <td class="tdLeft">Total Unitario CLP</td>
                ...
                <div id="row3" class="row" style="display:none">
                    <div class="col-sm-6">
                        <table border="0">
                            ...
                            <tr><td>Abastecimiento<div id="divMsg3"></div></td><td><textarea id="txtComentario3" cols="62" rows="4" onKeyPress="return ValidarComentario(event);" onKeyDown="ValidarLongitudComentario(this,'#divMsg3');" onKeyUp="ValidarLongitudComentario(this,'#divMsg3');" onPaste="return false;"></textarea></td></tr>
                            <tr><td colspan="2"><br /></td></tr>
