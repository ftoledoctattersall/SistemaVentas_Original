<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pagVisualizarBorradorVenta.aspx.vb" Inherits="SistemaVentasWeb.pagVisualizarBorradorVenta" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        ...
        <title>Ventas Web - Visualizacion Borrador Venta</title>
<!---
...
--->
        ...
        <script type="text/javascript" src="../Scripts/scrVisualizarBorradorVenta.js"></script>
    </head>
    <body style="zoom:75%">
        <form id="frmVisualizarBorradorVenta"  runat="server" method="post" defaultbutton="btnDisableEnter">
            <div class="container-fluid">
                <div id="row1" class="row">
                    <div class="col-sm-9">
                        <%=strHtmlBorradorVenta%>
