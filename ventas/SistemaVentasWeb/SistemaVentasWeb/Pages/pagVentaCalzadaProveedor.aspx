<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pagVentaCalzadaProveedor.aspx.vb" Inherits="SistemaVentasWeb.pagVentaCalzadaProveedor" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        ...
        <title>Ventas Web - Venta Calzada Proveedor</title>
        ...
        <script type="text/javascript" src="../Scripts/scrVentaCalzadaProveedorProducto.js"></script>
        <script type="text/javascript" src="../Scripts/scrVentaCalzadaProveedorProductoCarga.js"></script>
        <script type="text/javascript" src="../Scripts/scrVentaCalzadaProveedor.js"></script>
    </head>
    <body style="zoom:75%">
        <form id="frmVentaCalzadaProveedor" runat="server">
                    ...
                    <div class="col-sm-6">
                        <table border="0">
                            ...
                            <tr>
                                ...
                                <td class="tdLeft">Condicion Dada Por</td>
                                <td class="tdLeft" colspan="2"><input id="txtCondicion" type="text" class="textboxLong" onkeypress="return ValidarTexto(event);" onclick="LimpiarTextoCondicion();"/></td>
                                <td class="tdLeft"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="tdLeft" colspan="2"><select id="cmbMotivo" name="cmbMotivo" class="textboxLong" onchange="ActualizarMotivo();"></select><input id="txtMotivo" type="hidden"/><input id="hdnMotivo" type="hidden"/></td>
                                <%--<td class="tdLeft"></td>--%>
                            </tr>
                            <tr>
