...
Public Class clsFuncion
    ...
    Public Function ObtenerConeccion() As String
        ...
        strModalidad = My.Resources.rscServicioWeb.zModalidad
        If (strModalidad = "P") Then
            strServer = My.Resources.rscServicioWeb.ServerPRD
            strData = My.Resources.rscServicioWeb.DataPRD
            strUser = My.Resources.rscServicioWeb.UserPRD
            strPassword = My.Resources.rscServicioWeb.PasswordPRD
        Else
            strServer = My.Resources.rscServicioWeb.ServerTST
            strData = My.Resources.rscServicioWeb.DataTST
            strUser = My.Resources.rscServicioWeb.UserTST
            strPassword = My.Resources.rscServicioWeb.PasswordTST
        End If
    ...
    Public Function ObtenerFolioFactura(ByRef intEntrada As Integer) As Integer
        ...
        Try
            ...
            cnxAux = New SqlConnection(strConeccion)
            cnxAux.Open()
            sqlAux = "select isnull(FolioNum,0) as FolioNum from oinv where DocSubType = '--' and DocEntry=" + CStr(intEntrada)
            cmdAux = New SqlCommand(sqlAux, cnxAux)
            cmdAux.CommandTimeout = 600
            rdrAux = cmdAux.ExecuteReader()
            If rdrAux.Read Then
